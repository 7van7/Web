                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   ...
						   <div class="right">
						    <p class="small_tag">Почему ВКИ НГУ?</p>
                            <h2><span class="theme_color">Мы можем </span> дать тебе возможность </h2>
                            <p class="large">реализовать себя </p>
          </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-12 text_align_center padding_0">
                    <div class="full">
                        <img class="img-responsive" src="w/img/12.svg" alt="#" />
                    </div>
                </div>

                <div class="col-lg-6 col-md-12 white_fonts layout_padding padding_left_right">
                    <h3 class="small_heading">Высший колледж информатики НГУ готовит
профессионалов в области информационных технологий —
бурно развивающейся отрасли, в которой постоянно есть
спрос на специалистов</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="full">
                        <div class="heading_main text_align_left">
                           ...
                           <div class="right">
                            ...
                            <h2><span class="theme_color">Партнерские компании/</span> работодатели</h2>
                            </div>  
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="full">
                                           ...
                                           <div class="full text_align_center">
                                             <h3>Сбербанк Техногогии</h3>
                                           </div>
                                           <div class="full text_align_center">
                                             <p>Сотрудники «Сбербанк-Технологий» обучают востребованным на рынке труда дисциплинам:
                                                    - технология разработки и защиты баз данных,
                                                    - основы программирования,
                                                    - отладка и тестирование программного кода на уровне модуля,
                                                    - методы и средства разработки тестовых сценариев и тестового программного кода</p>
                                           </div>
                                        </div>
                                    </div>
                                   ...
                                   <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="full">
                                           ...
                                           <div class="full text_align_center">
                                             <p>Институт вычислителной математики и математической геофизики Сибирского отдела РАН</p>
                                           </div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_left white_fonts">
                           ...
                           <div class="right">
                            <h2>Основные <span class="theme_color"> сведения</h2>
                            <p class="large"></p>
                          </div>    
                        </div>
                    </div>
...
График работы: </br>
понедельник-четверг — 8:30—17:45</br>
пятница — 8:30—16:30</br>
обед — 13:00—14:000

</br>
Информация об учредителе (учредителях) образовательной организации
Учредителем Университета является Российская Федерация. Функции и полномочия учредителя Университета осуществляет Министерство науки и высшего образования Российской Федерации. Министр науки и высшего образования Российской Федерации — Котюков Михаил Михайлович.</p>
                </div>
                <div class="col-lg-12">
                    <div class="full">
    ...
    <div class="section layout_padding">
        <div class="container">
                    ...
                    <div class="full">
                        <div class="heading_main text_align_left">
						   ...
						   <div class="right">
                            ...
                            <h2><span class="theme_color">Выбирай путь</span> по которому ты будешь развиваться</h2>
			...
			<div class="row margin-top_30">
                ...
                <div class="col-lg-12">
                    <p>Информационные системы и программирование
Данная специальность входит в ТОП-50 (Утвержденный правительством РФ список наиболее востребованных на рынке труда, новых и перспективных профессий, требующих среднего профессионального образования).
Изучаются проектирование и разработка веб-приложений, интерфейсов пользователя, основы художественного дизайна для веб-приложений, администрирование сетей, обеспечение безопасности веб-приложений, Web-дизайн и графическое моделирование объектов. Студентов учат разрабатывать и интегрировать веб-приложения, администрировать базы данных, сопровождать программное обеспечение. В этом направлении осваивают все, что связано с веб-программированием: математическим, информационным, техническим, организационным.</p>
                </div>
